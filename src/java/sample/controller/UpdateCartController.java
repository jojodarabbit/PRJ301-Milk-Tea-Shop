...
public class UpdateCartController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (OrderDetail o : cart.getCart().values()) {
                if (o.getProductID().equals(productID)) {
                    String productName = o.getProductName();
                    String productImg = o.getProductImg();
                    int productPrice = o.getProductPrice();
                    order = new OrderDetail(productID, productName, productImg, productPrice, newQuantity);
                    break;
                }
            }
            cart.update(productID, order);
